...
export declare class RedisPlugin extends AddonPlugin {
    ...
    close(): void;
    clone(): import("@redis/client").RedisClientType<{
        graph: {
    ...
    ioClone(): Redis;
    get instance(): import("@redis/client").RedisClientType<{
        graph: {
            CONFIG_GET: typeof import("@redis/graph/dist/commands/CONFIG_GET.js");
            configGet: typeof import("@redis/graph/dist/commands/CONFIG_GET.js");
            CONFIG_SET: typeof import("@redis/graph/dist/commands/CONFIG_SET.js");
    ...
    get options(): redis.RedisClientOptions<redis.RedisModules, redis.RedisFunctions, redis.RedisScripts>;
